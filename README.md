...
注示例：
ID_BILL_PAYMENT_24_UNTREATED_被代付号码，查看是否有值，有值的话，执行命令清除后再去通知用户进行重试

---
# **搜索**
---
>[！搜索项目涉及：ES地址：http://172.16.168.245:5601/app/dev_tools#/console]
- 账号密码：elastic/elastic_1Q#

- 索引悉知：#/search-center-goods,search-center(后端命名两个查询索引)

- 1.##表条件查询##：
- #search-center-goods（商品数据查询，由炎黄同步ftp文件再全量同步数据到该索引下：search-center-goods，无表）；
- 2.##表条件查询##：
- search-center（活动、生活、服务查询，由搜索表:SEARCH_CENTER_INFO实时更新上传到ftp后再由ftp文件同步到该索引下:search-center）；

- #ftp主机20.26.210.184账号密码solr/solr_1Q#
- #实时更新文件路径/app/solr/tyss
- #全量更新文件路径/app/solr/tyss/temp/

- #实时更新上传文件路径/app/solr/tyss/temp/20240328(文件夹命名当天日期)上传文件区分：item_2_6（活动）、item_2_7（服务）、item_2_8（生活），上传完成后并同步数据到search-center索引内，再由搜索页面进行查询

- #全量实时更新上传文件路径/app/solr/tyss/temp/20231208(文件夹命名当天日期)上传文件必须是item_2_2的文件，然后调用全量更新接口进行同步数据到search-center-goods索引内，再由搜索页面进行查询


涉及使用查询：
- GET /search-center-goods/_search----商品查询
- GET /search-center-goods,search-center/_search----综合查询
- GET /search-center/_search----活动、生活、服务查询
- GET search-center/_analyze--分词查询


######综合查询-条件查询######
- #活动查询
GET /search-center-goods,search-center/_search
{
  "query": {
    "term": {
      "data_type": "20" 
...
- #分词查询--查询分词
GET search-center/_analyze
{
  "analyzer": "ik_smart",
  "text": "漫游出行测试"
}
- #商品查询
GET /search-center-goods/_search
{
  "query": {
    "term": {
      "data_type": ""
  ...
  "query": {
    "bool": {
      "must": [
        {
          "term": {
            "store_city_id.keyword": "4bc06f14ee40608ae05400237d3e09d4"
          }
        },
        {
          "term": {
  ...
  "query": {
    "bool": {
      "must": [
        {
          "term": {
            "store_id.keyword": "949a9c056528753501652d6e04e30040"
          }
        }
      ]
    }
...
- GET /search-center-goods/_search
{
  "query": {
    "term": {
      "iid.keyword": "30992179810903739138331643003847"
    }
  }
}

- DELETE /search-center-goods
...
- [1.postman 请求get post方法的 区别](https://www.cnblogs.com/mrwhite2020/p/14716102.html)

---
# **面试用到**
---
>[!TIP-面试过程中会问到的一些问题]
- [1.postman 请求get post方法的 区别](https://blog.csdn.net/weixin_30394333/article/details/95054367)
- [2.面试题HTTP和https的区别](https://www.jianshu.com/p/7b1c8093ddca)
- [3.SQL中各种Join语句（left、right、full、inner）的区别](https://blog.csdn.net/iamlaosong/article/details/56842589)
- [4.group by详解](https://blog.csdn.net/jerrytomcat/article/details/82351605)
- [5.Linux命令--日志文件里面查找关键字](https://zengwei.blog.csdn.net/article/details/84837106?utm_medium=distribute.pc_relevant.none-task-blog-2~default~BlogCommendFromMachineLearnPai2~default-2.control&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2~default~BlogCommendFromMachineLearnPai2~default-2.control)
- [6.使用命令行查找日志文件log内容](https://blog.csdn.net/ZXF_1991/article/details/110793981)
- [7.随身笔记linux查询日志内容命令](https://www.cnblogs.com/xh0203/p/12659242.html)
- [8.App测试中Android和IOS测试区别](https://www.jianshu.com/p/91d7acfb036e)
- [9.SVN 启动模式](https://www.runoob.com/svn/svn-start-mode.html)
- [10.Eclipse汉化教程（官方汉化包，傻瓜式操作，附带中英文快捷切换方式以及常见问题解决方案）](https://blog.csdn.net/qq_43736451/article/details/116240449)
- [11.linux面试常问命令](https://www.cnblogs.com/USTC-ZCC/p/13686351.html)
- [12.ADB常用命令及其用法大全](https://blog.csdn.net/qq_39969226/article/details/87897863)
- [13.浏览器url参数怎么转码_接口自动化测试（三）：关于URL](https://blog.csdn.net/weixin_42498981/article/details/112715005)
- [14.SQL查询模拟练习](https://www.nowcoder.com/exam/oj?page=1&tab=SQL%E7%AF%87&topicId=199)
- [15.SQL查询所有列](https://www.nowcoder.com/practice/f9f82607cac44099a77154a80266234a?tpId=199&tqId=1971219&ru=%2Fpractice%2Ff9f82607cac44099a77154a80266234a&qru=%2Fta%2Fsql-quick-study%2Fquestion-ranking&sourceUrl=%2Fexam%2Foj%3Fpage%3D1%26tab%3DSQL%25E7%25AF%2587%26topicId%3D298)
- [16.SQL编程题练习题（基础）](https://blog.csdn.net/jankin6/article/details/121856197)

---
# **疑难杂症解决方案**
---
>[!TIP解决国内 github.com 打不开的最最最准确方法]

解决方法：

- 1.打开网站http://tool.chinaz.com/dns/
在A类型中填写github.com,再点击监测按钮
![alt text](tupian/image.png)
- 2.复制下面任意一个ip
- 3.打开电脑文件C:\Windows\System32\drivers\etc下的host文件
- 4.在host文件的最后一刚加入刚才复制的IP
- 20.205.243.166         github.com
![alt text](tupian/image-1.png)
- 5.win+R 打开cmd 命窗口，执行命令ipconfig/flushdns
- ipconfig/flushdns
![alt text](tupian/image-2.png)
